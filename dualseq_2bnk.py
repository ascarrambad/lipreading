...
def cfg():
    ...
    ### NET SPECS
    MotSpec = '*FLATFEAT!2-1_*FLATFEAT!2_FC128t_*DP_FC32t_*DP_FC128t_*DP_*UNDOFLAT!0_*LSTM!128_*MASKSEQ'
    #
...
def main(
    ...
    mot.layers['DP-7'].extra_params['TrainingStatusTensor'] = training
    mot.layers['LSTM-9'].extra_params['SequenceLengthsTensor'] = seq_lens
    mot.layers['MASKSEQ-10'].extra_params['MaskIndicesTensor'] = seq_lens - 1
    ...
    trg = builder.add_specification('TRG', TrgSpec, ['MOT-MASKSEQ-10/Output', 'CNT-MASKSEQ-10/Output'], 'TrgWords')
