...
def cfg():
    ...
    ### NET SPECS
    DynSpec = 'CONVTD64r!5-1_*MPTD!2-2_CONVTD128r!5-1_*MPTD!2-2_CONVTD256r!7-1_*MPTD!2-2_*CONVLSTM!256-3_*MASKSEQ'
    #
    CntSpec = '*MASKSEQ_CONV64r!3-1_CONV64r!3-1_*MP!2-2_CONV128r!3-1_CONV128r!3-1_*MP!2-2_CONV256r!3-1_CONV256r!3-1_CONV256r!3-1_*MP!2-2'
    #
    TrgSpec = '*CONCAT!3_CONV256r!3-1_CONV128r!3-1_CONV256r!3-1_*FLATFEAT!3_FC128r'
    #
...
def main(
    ...
    # Create network
    builder.add_specification(DynSpec, 'Sequences', None)
    builder.add_specification(CntSpec, 'Sequences', None)
    builder.add_main_specification(TrgSpec, ['MASKSEQ-7/Output', 'MP-10/Output'], 'WordTrgs')
