...
ex = Experiment('GRID_LIPREAD_MCNet_AUTOENC')
...
def cfg():
    ...
    if DBPath != None:
        ex.observers.append(MongoObserver.create(url=DBPath, db_name='GRID_LIPREAD_MCNet_AUTOENC'))
