...
def main(
    ...
    restorer = builder.restore_model('Outdir/MCNet.AUTOENC/model%d/' % TrainedModelSeed)
    ...
    # Restore Parameters
    restorer.restore(trainer.session, tf.train.latest_checkpoint('Outdir/MCNet.AUTOENC/model%d/' % TrainedModelSeed))
