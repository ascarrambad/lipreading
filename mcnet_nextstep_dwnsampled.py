...
def cfg():
    ...
    ### NET SPECS
    MotSpec = '*FLATFEAT!2-1_CONV32r!3_*MP!2-2_CONV64r!5_*MP!2-2_*ORESHAPE_*CONVLSTM!64-3_*MASKSEQ'
    #
    CntSpec = 'CONV32r!3_CONV32r!3_*MP!2-2_CONV64r!3_CONV64r!3_*MP!2-2'
    #
    EncSpec = '*CONCAT!3_CONV64r!3_CONV32r!3_CONV64r!3'
    #
    ResSpec = '*RESGEN!3'
    #
    DecSpec = '*UNP!2_*RESGET!1_DECONV64r!3_DECONV32r!3_*UNP!2_*RESGET!0_DECONV32r!3_DECONV1t!3'
    #
...
def main(
    ...
    builder.add_specification('ENC', EncSpec, ['MOT-MASKSEQ-7/Output', 'CNT-MP-5/Output'], None)
    res_inputs = ['MOT-CONV-1/Output', 'MOT-CONV-3/Output',
                  'CNT-CONV-1/Output', 'CNT-CONV-4/Output']
