...
def cfg():
    ...
    ### NET SPECS
    MotSpec = '*FLATFEAT!2-1_*FLATFEAT!2_FC128t_*DP_FC128t_*DP_*UNDOFLAT!0_*LSTM!128_*MASKSEQ_FC128t'
    #
    ...
    if DBPath != None:
        ex.observers.append(MongoObserver.create(url=DBPath, db_name='LipR_MotionOnly_Valid', collection=Collection))
...
def main(
    ...
    # Create network
    mot = builder.add_specification('MOT', MotSpec, 'MotFrames', 'TrgWords')
